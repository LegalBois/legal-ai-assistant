...
PRACTICE_PROCESSED_FOLDER = Path("/home/deniskirbaba/Documents/legal-ai/practice_db/data/practice_processed")
SUMMARY_PROMPT_PATH = Path("/home/deniskirbaba/Documents/legal-ai/practice_db/summarization/summary_prompt.txt")
...
def main():
    ...
    for stem in tqdm(name_stems):
        with open(PRACTICE_PROCESSED_FOLDER / (stem + ".txt"), "r") as f:
            doc = f.read()
